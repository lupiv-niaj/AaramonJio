...
public class GSTBusinessAdapter extends BaseAdapter implements SpinnerAdapter {

    private Context context;
    private ArrayList<GSTBusinessModel> list;
    private LayoutInflater inflater;
    private SharedPreference_Main sharedPreference;

    public GSTBusinessAdapter(Context context, ArrayList<GSTBusinessModel> list) {
    ...
    public View getView(final int position, View v, ViewGroup arg2) {
        ...
        if (list.get(position) != null) {
            holder.TV_Name.setText(list.get(position).getGSTBusinessCategoryName());
        }
        return v;
    }
}
