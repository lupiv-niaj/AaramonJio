...
public class GPSTracker extends Service implements LocationListener {
     ...
     */
    public void showSettingsAlert(String title, String message, String setting_btn, String cancel_btn) {
        ...
        alertDialog.setPositiveButton(setting_btn,
        ...
        alertDialog.setNegativeButton(cancel_btn,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
                    }
